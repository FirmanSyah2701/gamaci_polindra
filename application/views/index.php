...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url('assets/flat/css/bootstrap-switch.min.css')?>">
    <link rel="stylesheet" type="text/css" href="<?= base_url('assets/flat/css/checkbox3.min.css')?>">
    <link rel="stylesheet" type="text/css" href="<?= base_url('assets/flat/css/jquery.dataTables.min.css')?>">
    <link rel="stylesheet" type="text/css" href="<?= base_url('assets/flat/css/dataTables.bootstrap.css')?>">
    <link rel="stylesheet" type="text/css" href="<?= base_url('assets/flat/css/select2.min.css')?>">
    <!-- CSS App -->
            ...
            <div id="navbar" class="navbar-collapse collapse " aria-expanded="true">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="nav-item dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#">Data Master &nbsp;<span class="fa fa-angle-down"></span></a>
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown" href="#">Teknik Komputer Jaringan</a>
