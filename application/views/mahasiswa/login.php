...
<title>Login</title>
<link rel="shotcut icon" href="<?= base_url('assets/layout/icon/logo.png')?>">
...
<body style="background: url(<?= base_url('assets/img/layout/a.jpg')?>) no-repeat center center fixed;">
         ...
         <div class="well center-block">
            ...
            <div class="row">
               <div class="col-xs-12 col-sm-12 col-md-12">
                  <div class="row">
                     <div class="col-xs-12 col-sm-12 col-md-12">
                     <form action="<?= base_url('mahasiswa/aksi_login')?>" method="post">
